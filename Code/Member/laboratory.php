...
{ 
	...
	$time=$_POST["txt_time"];	
	$ttest=$_POST["ddl"];
$qry="INSERT INTO lab_appo(labid,memid,labname, Appointmentdate, Appointmenttime,labtest_name,Isconform,Isnew) VALUES ('$labid','$memid','$labname','$date','$time','$ttest','$isconfirm','$isnew')";
//echo $qry;
$con = mysqli_connect("localhost","root","","careathome");
...
<div class="col-sm-9">
											...
											{
												echo "<option value='".$row["labtest_name"]."'>".$row['labtest_name']." &nbsp;&nbsp; (".$row['price']."  Rs)</option>";
