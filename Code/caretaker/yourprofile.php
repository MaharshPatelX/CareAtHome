													...
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																...
																<img style="height:200px;width: 300px;" src="caretakerimg/<?php echo $res['caretakepic']; ?>">
														...
														<div class="col-xs-12 col-sm-9">
															<h4 class="blue">
																<span class="middle"><?php echo " ".$res['caretakename'];?></span>
															...
															<div class="profile-user-info">
																...
																<div class="profile-info-row">
																	<div class="profile-info-name"> Care Taker's Name </div>

																	<div class="profile-info-value">
																		<span><?php echo " ".$res['caretakename'];?></span>
																	</div>
																</div>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span><?php echo " ".$res['contact'];?></span>
																	</div>
																</div>

																<div class="profile-info-row">
																	<div class="profile-info-name"> Mail Id </div>
