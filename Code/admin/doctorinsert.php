	...
	else
	{
		...
		else
		{
			if($ac=='1')
				...
				{
		$qry="Insert into doctor(docfname,doclname,lastdegree,docpic,experience,lcnt,viewcnt,doreg,email,contact,gender,uname,pwd,isactive,degree_cer,verified,dcname,available) values('$docfname','$doclname','$file_name','$file_namedp','$experience','$likecounter','$viewsofdoc','$docreg','$email','$conta','$gender','$un','$password','$isactive','$file_namec','$verified','$speciality','$available')";
		// echo $qry;
