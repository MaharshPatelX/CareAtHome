...
$qry=" INSERT INTO surgicalstore(areaid,surstorename, contactno, email, uname, pwd, dateofreg, dateoflv,vcnt,isactive,availability,verified) VALUES ('1','$surstorename','$conta','$email','$un','$pass','$doo','$doo','100','yes','yes','yes')";
	// echo $qry;
