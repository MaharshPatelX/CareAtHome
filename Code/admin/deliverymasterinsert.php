...
else
{
		...
		$qry="insert into delivery_master (sturid,testid,madid,deliverypername,email,contact,uname,pwd,deliveryperpic) value('2','3','1','$deliverypername','$email','$conta','$un','$pass','$deliverperpic')"; 
