...
?>
            ...
            <li class="light-blue dropdown-modal">
              <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                <img class="nav-user-photo" src="../labimg/<?php echo $labpic;?>">
                <span class="user-info">
                  <small>Welcome <?php echo $labname;?></small>
    ...
    <div class="main-container ace-save-state" id="main-container">
      ...
      <div id="sidebar" class="sidebar responsive ace-save-state">
        ...
        <!--  -->
         ...
         <li class="">
            <a href="laboldappoi.php">
              
              <span class="menu-text">
               Isconform Appointment
          ...
          <!-- <li class="">
            <a href="doctorregistration.php">
              
              <span class="menu-text"> Tests Done</span>
            </a>
          ...
          <li class="">
            <a href="upload reports(maharsh).php">
